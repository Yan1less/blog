...
<div id="content" class="white">
    <div class="bloc">
        <div class="title">验证信息<a class="toggle"></a></div>
        <div class="content">

            <label style="text-align: center">验证失败</label>
            <img src="/front/images/homura.jpg" style="width:150px;height: 200px;border: solid 1px red;margin: 0 auto">
